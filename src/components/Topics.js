  ...
  render() {
    return (
      <div {...styles.containerText}>
        <Text title="Tópicos" reverse subtitle={Globals.topics.title}>
          <p {...styles.p}>{Globals.topics.text}</p>
          <div {...styles.container}>
            ...
            />
            <Card
              topic="BEST PRATICES FOR REUSABLE UI COMPONENTS"
              author="rodrigooler"
              votes="11+"
            />
            ...
            <Card
              topic="PUSH NOTIFICATION + REACT NATIVE"
              author="felipedaraujo"
              votes="9+"
            />
          </div>
        </Text>
